      ...
      <div className="md:max-w-[70%] mx-auto flex flex-row h-full items-center">
        <div className="text-white md:w-[60%] pt-5">
          ...
          <div className="flex justify-center md:justify-start space-x-2 md:space-x-4">
            ...
            <div className="flex flex-col px-2 md:px-3 lg:px-6  border border-purple-600 justify-center items-center py-1 md:py-2 rounded-md">
              <div className="flex items-center space-x-2">
        ...
        <div className="w-[40%] hidden lg:inline-block pt-3 ">
          <div className="relative w-[430px] h-[440px]">
            <Image src={"/bannergirlnew.png"} fill alt="hero girl" />
          </div>
        </div>
      </div>
    </div>
